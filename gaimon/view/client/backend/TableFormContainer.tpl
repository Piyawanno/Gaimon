	...
	<div class="abstract_data_container" rel="dataContainer">
		<div class="flex flex-column-responsive space-between gap-10px">
			...
			<div class="flex space-between gap-5px">
				<div><div class="flex flex-column-responsive gap-5px" rel="operationContainer"></div></div>
			</div>				
		</div>
		<div class="abstract_table_container abstract_table abstract_formTable group_table" rel="table"></div>
		<div class="abstract_table_container" rel="pagination"></div>
