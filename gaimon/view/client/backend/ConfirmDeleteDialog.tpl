<div class="dialog">
	<div class="container">
		<div class="title flex gap-10px" style="background:red !important;" rel="title" localize>
			...
			<div class="flex-column-center" localize>Delete Confirmation</div>
		</div>
		...
		<div class="operation" rel="operation">
			<div class="width-100-percent flex-end gap-15px">
				<div rel="cancel" class="cancel" localize>Cancel</div>
				<div rel="confirm" class="alert" localize>Delete</div>
			</div>
		</div>
	</div>
</div>