		...
		<div class="login-box">
			...
			<div class="login-input-block">
				...
				<div class="flex">
					...
					<div style="width:calc(100% - 34px);display:flex;"><input class="login-input-text" type="password" placeholder="รหัสผ่าน" rel="password" autocomplete="off" localize required></div>
				</div>
			</div>
			<div class="login-input-block">
				...
				<div class="flex">
					...
					<div style="width:calc(100% - 34px);display:flex;"><input class="login-input-text" type="password" placeholder="ยืนยันรหัสผ่าน" rel="confirm_password" autocomplete="off" localize required></div>
				</div>
